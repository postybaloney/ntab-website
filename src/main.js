...
function loadModel() {
  ...
  gltfLoader.load('/public/brain_scene.gltf', (gltfScene) => {
  ...
  //   loadedModel.position.z = scrollPosY + 5;
  //   console.log(window.scrollY);
  // })

  // clickbox.addEventListener('click', (ev) => {
  //   const coords = {
  //     x: (ev.offsetX / window.innerWidth) * 2 - 1,
  //     y: -(ev.offsetY / window.innerHeight) * 2 + 1
  //   };
